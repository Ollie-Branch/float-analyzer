...
int main (int argc, char** argv) {
	...
	std::cout 
		<< std::bitset<32>(ShredFloatToData(input_float)) 
		<< std::endl;
	std::cout << "" << std::endl;
	...
	std::cout << 
		...
		<< std::endl;
	std::cout << std::bitset<8>(ShredFloatExpUnbiased(input_float)) << std::endl;
	std::cout << "The decimal representation of the float's unbiased exponent is: "
		<< std::endl;
	std::cout << ShredFloatExpUnbiased(input_float) << std::endl;
	std::cout << "" << std::endl;
	...
	std::cout << ShredFloatExp(input_float) << std::endl;
	std::cout << "" << std::endl;

	std::cout << 
		"The binary value of the mantissa (the fractional part of the number in binary scientific notation)"
		<< std::endl;
	std::cout << std::bitset<23>(ShredFloatMantissaRaw(input_float)) << std::endl;
	std::cout << "The decimal value of the mantissa is: " << std::endl;
	std::cout << ShredFloatMantissa(input_float) << std::endl;
	...
	std::cout << std::pow(2, (24 + (ShredFloatExp(input_float)))) << std::endl;
}
